            ...
            <div className="grid grid-cols-3 gap-4 ">
              ...
              {/* Firebase */}
                <div className="flex flex-col justify-center align-center text-center items-center w-auto">
                  <Image className="bg-slate-400 p-2 rounded-full border-slate-200 border-2 mb-2" src={'/firebaselogo.svg'} width={50} height={50}/> 
              ...
              {/* React */}
                <div className="flex flex-col justify-center align-center text-center items-center">
                  <Image className="bg-slate-400 p-2 rounded-full border-slate-200 border-2 mb-2" src={'/reactlogo.svg'} width={50} height={50}/>
                  <h1 className="font-semibold text-md text-center">
                    React.js
                  </h1>
                  <p className="text-sm w-4/5 text-slate-400">
              ...
              {/* API ninja  */}
                <div className="flex flex-col justify-center align-center text-center items-center">
                  <Link href={'https://rapidapi.com/apininjas/api/exercises-by-api-ninjas'}> <Image className="bg-slate-400 hover:bg-slate-200 p-2 rounded-full border-slate-200 border-2 mb-2 ease-in-out duration-300" src={'/ninjaapi.png'} width={50} height={50}></Image>
</Link>
                  <h1 className="font-semibold text-md text-center">
